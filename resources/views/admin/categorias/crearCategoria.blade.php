...
@section('content')
    <div class="p-4 md:p-6 max-w-4xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl md:text-3xl font-bold">Crear Nueva Categoría</h1>
            <p class="text-gray-400">Añade una nueva categoría al catálogo</p>
        </div>

        <form action="{{ route('categorias.store') }}" method="POST" enctype="multipart/form-data" class="bg-custom-dark3 p-6 rounded-xl shadow-md">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    <div>
                        <label for="imagen_categoria" class="block text-sm font-medium text-gray-400 mb-2">Imagen de la Categoría</label>
                        <input type="file" 
